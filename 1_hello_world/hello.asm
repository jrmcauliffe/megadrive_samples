...
tile_id_r		equ $6
tile_id_d		equ $7
tile_count		equ $8	; Last entry is just the count
...
-	move.l (a0)+, vdp_data						; Write tile line (4 bytes per line), and post-increment address
	...
	; Each scroll plane is made up of a 64x32 tile grid (this size is specified in VDP register $10),
	...
	; Plane A's cell grid starts at address $C000, which is specified in VDP register $2.
	;
	...
	; register (VDP register $F) is set to 2, so the destination address
